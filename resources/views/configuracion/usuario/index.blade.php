	    		...
	    		<div class="col-xs-12">
	    			<div class="box">
	    				<div class="box-header">
	    					<h3 class="box-title"><a href="usuario/nuevo-usuario" class="btn btn-primary">Crear Nuevo</a></h3>
	    				</div>
	    				<div class="box-body">
	    							...
	    							<tbody>
	    								@foreach($datos as $dato)
		    								<tr>
		    									...
		    									<td><a href="{!! action('UsuarioController@show', $dato->id) !!}">{{ isset($dato->rol->nombre) ? $dato->rol->nombre : 'NO POSEE' }}</a></td>
                                                <td><a href="{!! action('UsuarioController@show', $dato->id) !!}">{{ $dato->puesto->nombre }}</a></td>
                                            </tr>
		    							@endforeach
	    							</tbody>
	    						</table>
